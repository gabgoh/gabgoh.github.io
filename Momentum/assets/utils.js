...
var jetc = d3.scaleLinear()
    .domain([-100,1.5,2,3,4,5,10,60,200,500])
    .range(colorbrewer.RdYlBu[10]);

var divergent = d3.scaleLinear()
    .domain([-0.03,0,0.03])
...
/*
Custom Slider for Eigenvalue Visualizations.
*/
...
/* Render heatmap of f with colormap cmap */
...
//   var x = xy[0]; var y = xy[1]
//   var alpha = 5
//   var fx   = 0.5*(10*x*x + 5*y*y + 2*alpha*x*y)
//   var dfx  = [10*x + alpha*y , alpha*x +  5*y]
//   return [fx, dfx] 
// }
