function renderFlowWidget(divname) {
...
var display = renderGrid(d3.select("#" + divname))
...
// var getState = slider(slidersvg, 
//        onDragSlider, 
//        getStepsConvergence(FlowSigma,2/8).map(function(i) {return Math.log(i) + 1}), 
//        FlowSigma, 
//        showEigen,
//        hideEigen)

display(iter(100), jetc)

var display2 = renderGrid(d3.select("#" + divname), 100)

display2(FlowU[21], divergent)
